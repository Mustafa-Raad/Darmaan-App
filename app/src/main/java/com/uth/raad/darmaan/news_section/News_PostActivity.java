...
public class News_PostActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.news_post_activity);
    ...
    private void startPosting() {
        postProgress.setMessage("Posting to Blog ...");
        ...
        if(!TextUtils.isEmpty(title_val) && !TextUtils.isEmpty(dsc_val) && GalleryImage != null){
            ...
            filePath.putFile(GalleryImage).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    //startActivity(new Intent(News_PostActivity.this, NewsMainView.class));
