...
public class Kandahar_Map_Section_Parts extends Activity implements View.OnClickListener {
    Button btn2;
    Button btn3;
    Button btn4;
   @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.kandahar_map_section_parts);
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.doctor) {
            ...
            //startActivity(i);
            Toast.makeText(Kandahar_Map_Section_Parts.this, "Contents Update Soon...", Toast.LENGTH_LONG).show();
        }
